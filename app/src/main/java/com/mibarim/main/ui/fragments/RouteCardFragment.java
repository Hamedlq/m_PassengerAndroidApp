...
import com.mibarim.main.util.RecyclerItemClickListener;
...
public class RouteCardFragment extends Fragment {
    ...
    private RouteListRecyclerAdapter mAdapter;
...
*/
        ...
        mAdapter = new RouteListRecyclerAdapter(items, itemTouchListener);
