 ...
 */
public class SuggestRouteCardActivity extends BootstrapActivity {
  ...
  /*      if (getCacheDir() != null) {
    ...
    private void initScreen() {
        ...
        fragmentManager.beginTransaction()
                .add(R.id.main_container, new SuggestRouteCardFragment())
                .commit();
    ...
    public void onNetworkErrorEvent(NetworkErrorEvent event) {
        Toaster.showLong(SuggestRouteCardActivity.this, getString(R.string.network_error), R.drawable.toast_warn);
    }
    ...
    public void getRouteImage(final ImageView imageView, final int routeId) {
        new SafeAsyncTask<Boolean>() {
            ...
            public Boolean call() throws Exception {
                if (authToken == null) {
                    serviceProvider.invalidateAuthToken();
                    authToken = serviceProvider.getAuthToken(SuggestRouteCardActivity.this);
                }
...
//                    finish();
    ...
    public void RequestRideShare() {
        if (selectedRoute == null || selectedRoute.RouteId == 0) {
            Toaster.showLong(SuggestRouteCardActivity.this, R.string.please_select);
        } else {
            showProgress();
            new SafeAsyncTask<Boolean>() {
                @Override
...
//                    finish();
                ...
                protected void onSuccess(final Boolean succees) throws Exception {
                    ...
                    new HandleApiMessages(SuggestRouteCardActivity.this, response).showMessages();
                    //finishIt();
                }
            }.execute();
        }
...
//                    finish();
    ...
    private void getImageFromServer(final String imageId) {
        new SafeAsyncTask<Boolean>() {
            ...
            @Override
            public Boolean call() throws Exception {
                String token = serviceProvider.getAuthToken(SuggestRouteCardActivity.this);
...
//                    finish();
    ...
    public void gotoTripProfile(BriefRouteModel selectedItem) {
        Intent intent = new Intent(this, TripProfileActivity.class);
        intent.putExtra("SelectedBriefRouteModel", selectedItem);
        this.startActivity(intent);
    }
}
